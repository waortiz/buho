...
public class HojaVidaConsulta {
    ...
    /**
     * @return the productoConocimiento
     */
    public String getProductoConocimiento() {
        return productoConocimiento;
    }

    /**
     * @param productoConocimiento the productoConocimiento to set
     */
    public void setProductoConocimiento(String productoConocimiento) {
        this.productoConocimiento = productoConocimiento;
    }
