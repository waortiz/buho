...
<div id="contenido">         
    <div class="container">
        <legend><h3>Preseleccionados</h3></legend>
        <div class="row">
            <div class="col-md-12">
        ...
        <div id="divDescargar" style="display: none;" align="center">
            <center><label>Descargar listado</label><button class="btn btn-success " id="btnDescargar" onclick="descargarPreseleccionados()" style="margin-left: 10px"><i class="fa fa-download"></i></button></center>
        </div>
    ...
    <div id="md_preseleccionados" class="modal fade" role="dialog" disabled>
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header mhsuccess">
                    <h4>Por favor espere. Consultando preseleccionados...</h4>
                </div>
                <div class="modal-body">
                    <div class="barprogress">
                        ...
                        </div><span>Evaluando preseleccionados...</span>
                    </div>
                </div>
    ...
    <div id="md_descargar_preseleccionados" class="modal fade" role="dialog" disabled>
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header mhsuccess">
                    <h4>Por favor espere. Descargando preseleccionados...</h4>
                </div>
                <div class="modal-body">
                    <div class="barprogress">
                        <div class="progress" >
                        ...
                        </div><span>Descargando preseleccionados...</span>
                    </div>
                </div>
                <div class="modal-footer">
                </div>
...
<script>
    ...
    function descargarPreseleccionados() {
