...
<div id="contenido">         
  ...
  <script>
    function limpiarTipoExperiencia() {
        $('#cboTipoExperiencia').val("").trigger('change');
    }
    ...
    function buscarHojasVida() {
        ...
        formData.append("tipoExperiencia", $('#cboTipoExperiencia').val());
        formData.append("nucleoBasicoConocimiento", $('#cboNucleoBasicoConocimiento').val());
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/hojasVida/consultarHojasVidaTipoExperiencia",
            data: formData,
            processData: false,
            contentType: false,
                ...
                if (response !== "") {
                    ...
                    for (var i = 0; i < hojasVida.length; i++) {
                        tblHojasVida.row.add([
                            ...
                            hojasVida[i].cargo,
                            hojasVida[i].tipoExperiencia,
                            hojasVida[i].nucleoBasicoConocimiento,
    ...
    function descargar() {
        ...
        $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/hojasVida/descargarHojasVidaTipoExperiencia?tipoExperiencia=" + $('#cboTipoExperiencia').val() + "&nucleoBasicoConocimiento=" + $('#cboNucleoBasicoConocimiento').val(),
                processData: false,
                contentType: false,
                success: function (response) {
                    $('#md_descargar_resultados').modal('hide');
                    if (response != "") {
                        window.location.href = "${pageContext.request.contextPath}/hojasVida/descargarHojasVidaTipoExperiencia?tipoExperiencia=" + $('#cboTipoExperiencia').val() + "&nucleoBasicoConocimiento=" + $('#cboNucleoBasicoConocimiento').val();
                    }
                },
