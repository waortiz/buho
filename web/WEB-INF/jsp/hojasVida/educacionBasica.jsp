...
<div id="contenido">         
                    ...
                    <table class="table table-hover tableestilo" id="tblHojasVida">
                        <thead>
                            <tr>
                                ...
                                <th>A&ntilde;o de graduacion</th>
                                <th>Validado</th>
  ...
  <script>
    ...
    function buscarHojasVida() {
        $('#formHV').hide();
        $('#divDescargar').hide();
        if($('#cboNivelEstudio').val() == "" && $('#cboAnyoGraduacionInicial').val() == "" && $('#cboAnyoGraduacionFinal').val() == "") {
        ...
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/hojasVida/consultarHojasVidaEducacionBasica",
            data: formData,
            processData: false,
            contentType: false,
                ...
                if (response !== "") {
                    ...
                    for (var i = 0; i < hojasVida.length; i++) {
                        tblHojasVida.row.add([
                            ...
                            hojasVida[i].nivelEstudio,
                            getValue(hojasVida[i].anyoGraduacion),
