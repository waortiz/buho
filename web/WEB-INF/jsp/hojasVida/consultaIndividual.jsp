...
<div id="contenido">         
    <div class="container">
        <legend>Consulta individual de hoja de vida</legend>
        <div class="row">
            <div class="col-md-4">
...
<script>
    ...
    function descargar() {
        ...
        $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/hojasVida/descargarHojasVidaIndividual?idPersona=" + $('#cboNumeroIdentificacion').val() + "&nombres=" + $('#buscarNombres').val() + "&apellidos=" + $('#buscarApellidos').val(),
                processData: false,
                contentType: false,
                success: function (response) {
                    if (response != "") {
                        window.location.href = "${pageContext.request.contextPath}/hojasVida/descargarHojasVidaIndividual?idPersona=" + $('#cboNumeroIdentificacion').val() + "&nombres=" + $('#buscarNombres').val() + "&apellidos=" + $('#buscarApellidos').val();
                    }
                    $('#md_descargar_resultados').modal('hide');
                },
