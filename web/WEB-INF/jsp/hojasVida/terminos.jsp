                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group" >
                                                    <div class="table-responsive" id="tablep">
                                                        ...
                                                        <center>
                                                            <table class="table table-bordered tableestilo" id="table1">
                                                                <thead>
                                                                    <tr>
                                                                        <th colspan="2">2. NORMAS DE USO GENERAL</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="text-align: left;">Numeral<button class="btn btn-success btn-sm btntable1" style="float: right;" type="button">Seleccionar todos</button></th>
                                                        ...
                                                        <center>
                                                            <table class="table table-bordered tableestilo" id="table2">
                                                                <thead>
                                                                    <tr>
                                                                        <th colspan="2">3. OBLIGACIONES DEL USUARIO.</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="text-align: left;">Numeral<button class="btn btn-success btn-sm btntable2" style="float: right;" type="button">Seleccionar todos</button></th>
                                                                        <th style="width:56.8pt;">Acepto</th>
                                                                    </tr>
                                                                </thead>
                                                                <tr>
                                                        ...
                                                        <center>
                                                            <table class="table table-bordered tableestilo" id="table3">
                                                                <thead>
                                                                    <tr>
                                                                        <th colspan="2">4. CONDICIONES ESPECIALES DE USO.</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="text-align: left;">Numeral<button class="btn btn-success btn-sm btntable3" style="float: right;" type="button">Seleccionar todos</button></th>
                                                                        <th style="width:56.8pt;">Acepto</th>
                                                                    </tr>
                                                                </thead>
                                                                <tr>
                                                        ...
                                                        <center>
                                                            <table class="table table-bordered tableestilo" id="table4">
                                                                <thead>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <th style="text-align: left;">Numeral<button class="btn btn-success btn-sm btntable4" style="float: right;" type="button">Seleccionar todos</button></th>
                                                                        <th style="width:56.8pt;">Acepto</th>
                                                                    </tr>
                                                                </thead>
                                                                <tr>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="table-responsive" id="tablep">
                                                        <center>
                                                            <table class="table table-bordered tableestilo" id="table6">
                                                                <thead>
                                                                    <tr>
                                                                        <th colspan="2">AVISO DE AUTORIZACIÓN PARA TRATAMIENTO DE DATOS PERSONALES</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="text-align: left;">Numeral<button class="btn btn-success btn-sm btntable6" style="float: right;" type="button">Seleccionar todos</button></th>
                                                                        <th style="width:56.8pt;">Acepto</th>
                                                                    </tr>
                                                                </thead>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <p>
                                                                            De esta forma,
                                                                            reconozco que la información por mi suministrada estará a disposición, para
                                                                            los mismos fines y con las mismas restricciones, teniendo derecho entre otros
                                                                            a conocer, actualizar, rectificar o revocar la autorización de la información
                                                                            o datos proporcionados para esta actividad conforme a la Ley Estatutaria
                                                                            antes señalada.
                                                                        </p>
                                                                    </td>
    ...
    $('#terminos').submit(function (evt) {
        ...
        $.ajax({
            ...
            error: function (xhr, ajaxOptions, thrownError) {
                bootstrap_alert_terminos.warning("Error al aceptar los términos.");
            }});
    });
