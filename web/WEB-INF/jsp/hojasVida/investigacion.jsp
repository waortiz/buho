...
<div id="contenido">         
    <div class="container">
        <legend>Consulta de hoja de vida por investigación</legend>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                <div class="form-group form-inline">
                    ...
                    <select style="width: 85%;" id="cboTipoInvestigador" class="js-select-basic-single js-states form-control">
                        <option ></option>
                        <c:forEach var="tipoInvestigador" items="${tiposInvestigador}">
                            <option value="${tipoInvestigador.getId()}">${tipoInvestigador.getNombre()}</option>
                        </c:forEach>                                                 
                    </select>
                    ...
                    <table class="table table-hover tableestilo" id="tblHojasVida">
                        <thead>
                            <tr>
                                ...
                                <th style="width:30%">URL (CVLAC)</th>
  ...
  <script>
    ...
    function limpiarTipoInvestigador() {
        $('#cboTipoInvestigador').val("").trigger('change');
    }
    ...
    function buscarHojasVida() {
        ...
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/hojasVida/consultarHojasVidaInvestigacion",
            data: formData,
            processData: false,
            contentType: false,
                ...
                if (response !== "") {
                    ...
                    for (var i = 0; i < hojasVida.length; i++) {
                        tblHojasVida.row.add([
                            ...
                            hojasVida[i].tipoInvestigador,
                            hojasVida[i].urlCVLAC,
