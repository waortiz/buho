...
<div id="contenido">         
    <div class="container">
        <legend>Consulta general de hoja de vida</legend>
        <div class="row">
            <div class="col-md-">
...
<script>
    ...
    function descargar() {
        ...
        $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/hojasVida/descargarHojasVidaGeneral",
                processData: false,
                contentType: false,
                success: function (response) {
                    if (response != "") {
                        window.location.href = "${pageContext.request.contextPath}/hojasVida/descargarHojasVidaGeneral";
                    }
                    $('#md_descargar_resultados').modal('hide');
                },
