...
<div id="contenido">         
    <div class="container">
            ...
            <div class="col-md-6">
                <div class="form-group form-inline">
                    <label>N&uacute;cleo b&aacute;sico de conocimiento </label><a href="#" data-toggle="tooltip" data-placement="right" title = "Debe indicar el núcleo básico de conocimiento">
                        <i class="fa fa-question-circle" aria-hidden="true"></i></a><br>
                    <select style="width: 85%;" id="cboNucleoBasicoConocimiento" class="js-select-basic-single js-states form-control">
                        <option ></option>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group form-inline">
                    <label>¿Título de extranjero?</label><a href="#" data-toggle="tooltip" data-placement="right" title = "Debe indicar si el título es extranjero">
                        <i class="fa fa-question-circle" aria-hidden="true"></i></a><br>
                    <div id="radioBtn" class="btn-group" style="margin-left: 40px;">
                        <a class="btn btn-primary btn-sm notActive" data-toggle="tituloExterior"  data-title="true"  id="btnTituloExteriorSi">Si</a>
                        <a class="btn btn-primary btn-sm notActive" data-toggle="tituloExterior"  data-title="false" id="btnTituloExteriorNo">No</a>
                    </div>
        ...
        <div id="divHojasVida" style="overflow-y: auto; max-height:500px;">
...
<script>
    ...
    function limpiarNivelEstudio() {
        $('#cboNivelEstudio').val("").trigger('change');
    }

    function limpiarAnyoGraduacionInicial() {
        $('#cboAnyoGraduacionInicial').val("").trigger('change');
    }

    function limpiarAnyoGraduacionFinal() {
        $('#cboAnyoGraduacionFinal').val("").trigger('change');
    }

    function limpiarTituloExterior() {
    ...
    function buscarHojasVida() {
        ...
        formData.append("nivelEstudio", $('#cboNivelEstudio').val());
        formData.append("anyoGraduacionInicial", $('#cboAnyoGraduacionInicial').val());
        formData.append("anyoGraduacionFinal", $('#cboAnyoGraduacionFinal').val());
            ...
            success: function (response) {
                ...
                if (response !== "") {
                    ...
                    if (hojasVida.length > 0) {
                        $('#divDescargar').show();
                        var numeroIdentificacionAnterior = hojasVida[0].numeroIdentificacion;
                        var divHeader = "";
                        var divBody = "";
                        divHeader = "<div class='row'>"
                              + "<div class='col-md-12'>"
                              + "<div class='row'>"
                              + "<div class='col-md-3'>"
                              + "<label>Cédula:&nbsp;</label><input type='text' style='border:0;' readonly  value='" + hojasVida[0].numeroIdentificacion + "'/></div>"
                              + "<div class='col-md-3'><label>Nombres:&nbsp;</label><input type='text' style='border:0;' readonly  value='" + hojasVida[0].nombres + " " + hojasVida[0].apellidos + "'/></div></div>"
                              + "<div class='table-responsive'>"
                        ...
                        for (var i = 1; i < hojasVida.length; i++) {
                            if(numeroIdentificacionAnterior != hojasVida[i].numeroIdentificacion) {
                                ...
                                $('#divHojasVida').append(divHeader + divBody);
                                divHeader = "<div class='row'>"
                                      + "<div class='col-md-12'>"
                                      + "<div class='row'>"
                                      + "<div class='col-md-3'>"
                                      + "<label>Cédula:&nbsp;</label><input type='text' style='border:0;' readonly  value='" + hojasVida[i].numeroIdentificacion + "'/></div>"
                                      + "<div class='col-md-3'><label>Nombres:&nbsp;</label><input type='text' style='border:0;' readonly  value='" + hojasVida[i].nombres + " " + hojasVida[i].apellidos + "'/></div></div>"
                                      + "<div class='table-responsive'>"
                                      + "<table class='table table-hover tableestilo'>"
                                      + "<thead>" 
                                      + "<tr>" 
